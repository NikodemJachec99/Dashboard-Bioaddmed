    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('global_role', models.CharField(choices=[('admin', 'Admin'), ('member', 'Member')], default='member', max_length=32)),
                ('avatar', models.URLField(blank=True)),
                ('bio', models.TextField(blank=True)),
                ('year_of_study', models.CharField(blank=True, max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proficiency', models.CharField(choices=[('beginner', 'Beginner'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced'), ('expert', 'Expert')], default='intermediate', max_length=32)),
